...
//można też reduce
//let peoples = cities.reduce(function(a, b) {
//    return {a.people + b.people}
//}, {people : 0});

console.log(`Liczba ludzi w miastach: ${peoples}`);

const cityLarge = cities.find(function(city) {
    return city.people > 10000;
})

console.log(`Pierwsze miasto z liczbą ludności większą niż 10000 to: ${cityLarge.name}`);


const avg = peoples / cities.length;

const citiesAboveAvg = cities.filter(function(city) {
    return city.people > avg;
})
console.log(`Przeciętna liczba ludzi w miastach: ${avg.toFixed(2)}`);
console.log(`Miasta z ludnością ponad przeciętną:`);
console.log(citiesAboveAvg);



console.log(`Miasta z ludnością ponad 10000:`);
const citiesLarge = cities.filter(function(city) {
    return city.people > 10000;
})
console.log(citiesLarge);

if (citiesLarge.length >= cities.length) {
  console.log(`W Polsce jest więcej miast z ludnością 10000 i więcej`);
} else {
  console.log(`W Polsce jest więcej miast z ludnością < 10000`);
}
console.log(`Jest ${cities.length} wszystkich miast, w tym ${citiesLarge.length}, które mają 10000 i więcej ludności`);